              ...
              <div className="w-full max-w-[800px] h-[650px] overflow-y-auto flex flex-col border border-white/20 rounded-3xl backdrop-blur-xl bg-gradient-to-br from-white/5 to-transparent">
                ...
                <div className="flex items-center gap-4 p-5 border-b border-white/10">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <p className="text-xl text-white/60 leading-snug line-clamp-2">
                      ...
                      (product: any, index: number) => (
                        ...
                        >
                          <div className="flex items-start gap-6">
                            <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-[#7CB342] to-[#1EC800] flex items-center justify-center shrink-0 mt-0.5">
                                ...
                                <ul className="space-y-1">
                                  {product.content.map(
                                    (item: string, i: number) => (
                                      <li
                                        key={i}
                                        className="text-xl text-white/60 leading-relaxed flex items-start gap-2"
                                      >
                                        <span className="text-[#7CB342] mt-1">
                                          •
                                        </span>
                                        <span>{item}</span>
                                      </li>
